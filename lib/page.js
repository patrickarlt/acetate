...
Page.prototype._setupBuild = function(){
  var outputDir =  path.join(this._acetate.config.root, this._acetate.config.dest, path.dirname(this.dest));
...
Page.prototype._write = function (){
  var outputPath = path.join(this._acetate.config.root, this._acetate.config.dest, this.dest);
