...
utils.start({
  ...
  site.once('build', function () {
    tap.test('should build a page at root with a root url', function (t) {
    ...
    tap.test('should build a page at root without a pretty url', function (t) {
    ...
    tap.test('should build a page at root with a pretty url', function (t) {
    ...
    tap.test('should build an index page in a folder', function (t) {
    ...
    tap.test('should build a page in a folder without a pretty url', function (t) {
    ...
    tap.test('should build a page in a folder with a pretty url', function (t) {
    ...
    tap.test('should build an index page in a nested folder', function (t) {
    ...
    tap.test('should build a page in a nested folder without a pretty url', function (t) {
    ...
    tap.test('should build a page in a nested folder with a pretty url', function (t) {
    ...
    tap.test('should build a non-html without a pretty url', function (t) {
